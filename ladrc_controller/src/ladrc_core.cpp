...
double LADRCController::update(double reference, double measurement)
{
  if (!initialized_) {
    return 0.0;
  }
  ...
  // Calculate control output using LSEF
  double u = controller_->calculate(reference, z1, z2, z3, params_.b0);
